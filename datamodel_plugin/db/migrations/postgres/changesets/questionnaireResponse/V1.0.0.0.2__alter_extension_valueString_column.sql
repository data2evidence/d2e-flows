...
--changeset alp:V1.0.0.0.2__alter_extension_valueString_column

--Add 2 new columns(EXTENSION_EFFECTIVE_DATE_URL, EXTENSION_VALUEDATE) to GDM.QUESTIONNAIRE_RESPONSE table 
ALTER TABLE "GDM.QUESTIONNAIRE_RESPONSE"
ADD COLUMN "EXTENSION_EFFECTIVE_DATE_URL" VARCHAR(500) NULL,
ADD COLUMN "EXTENSION_VALUEDATE" VARCHAR(50) NULL;


--Add 2 new columns(EXTENSION_EFFECTIVE_DATE_URL, EXTENSION_VALUEDATE) to the VIEW::GDM.QUESTIONNAIRE_RESPONSE_BASE
...
"QR"."EXTENSION_EFFECTIVE_DATE_URL",
"QR"."EXTENSION_VALUEDATE"
