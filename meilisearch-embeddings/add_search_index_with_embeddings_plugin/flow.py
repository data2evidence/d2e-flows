...
from add_search_index_with_embeddings_plugin.config import meilisearchAddIndexType
import sys
import importlib
...
def add_search_index_with_embeddings_plugin(options: meilisearchAddIndexType):
    setup_plugin()
