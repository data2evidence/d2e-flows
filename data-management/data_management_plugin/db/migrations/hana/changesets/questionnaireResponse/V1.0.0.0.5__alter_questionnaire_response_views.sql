...
--changeset alp:V1.0.0.0.5__alter_questionnaire_response_views
...
CREATE OR REPLACE VIEW "VIEW::GDM.QUESTIONNAIRE_RESPONSE_LATEST" AS
SELECT "B".*
FROM (
	SELECT "PERSON_ID", "QUESTIONNAIRE_REFERENCE", "LINK_ID", MAX("AUTHORED") AS "MAX_AUTHORED"
	FROM "VIEW::GDM.QUESTIONNAIRE_RESPONSE_BASE" 
	GROUP BY "PERSON_ID", "QUESTIONNAIRE_REFERENCE", "LINK_ID"
) AS "TEMP" 
INNER JOIN "VIEW::GDM.QUESTIONNAIRE_RESPONSE_BASE" AS "B" 
ON "TEMP"."PERSON_ID" = "B"."PERSON_ID"
