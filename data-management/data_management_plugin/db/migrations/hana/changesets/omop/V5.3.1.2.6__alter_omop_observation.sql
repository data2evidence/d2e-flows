...
--changeset alp:V5.3.1.2.6__alter_omop_observation

ALTER TABLE OBSERVATION ADD ("OBS_EVENT_FIELD_CONCEPT_ID" INTEGER);
...
--rollback ALTER TABLE OBSERVATION DROP ("OBS_EVENT_FIELD_CONCEPT_ID");
