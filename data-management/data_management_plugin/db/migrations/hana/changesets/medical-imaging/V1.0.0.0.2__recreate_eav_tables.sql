...
CREATE TABLE DICOM_FILE_METADATA(
    ...
    METADATA_SOURCE_VALUE_REPRESENTATION NVARCHAR(10),
    METADATA_SOURCE_VALUE_MULTIPLICITY NVARCHAR(10),
...
CREATE TABLE DICOM_DATA_ELEMENT(
    ...
    VALUE_REPRESENTATION NVARCHAR(10),
    VALUE_MULTIPLICITY NVARCHAR(10),
    IS_PRIVATE BOOLEAN,
    IS_RETIRED BOOLEAN,
