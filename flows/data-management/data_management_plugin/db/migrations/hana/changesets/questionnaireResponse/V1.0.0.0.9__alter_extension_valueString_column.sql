...
--changeset alp:V1.0.0.0.9__alter_extension_valueString_column

--Add 2 new columns(EXTENSION_URL, EXTENSION_VALUESTRING) to GDM.QUESTIONNAIRE_RESPONSE table 
ALTER TABLE "GDM.QUESTIONNAIRE_RESPONSE" ADD (EXTENSION_EFFECTIVE_DATE_URL NVARCHAR(500) NULL, EXTENSION_VALUEDATE VARCHAR(50) NULL);
