...
--changeset alp:V1.0.0.1.2__create_omop_tables_in_lowercase
...
CREATE TABLE concept_hierarchy (
	...
	level3_concept_name varchar(1000) NULL,
	level2_concept_name varchar(1000) NULL,
	level1_concept_name varchar(1000) NULL);
...
CREATE TABLE cdm_source (
			...
			cdm_version_concept_id integer NULL,
			vocabulary_version varchar(20) NULL,
			vocabulary_schema varchar(255) DEFAULT '${VOCAB_SCHEMA}');
...
CREATE TABLE cohort_definition (
			...
			cohort_modification_date timestamp NULL,
