...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.observation_period
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.visit_detail
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.procedure_occurrence
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.device_exposure
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.death
(
    person_id               bigint      NOT NULL,
...
CREATE TABLE @schema_name.note_nlp
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.specimen
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @schema_name.fact_relationship
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @schema_name.care_site
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.payer_plan_period
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.drug_era
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.dose_era
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE @schema_name.condition_era
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @schema_name.cdm_source
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @schema_name.cohort_definition
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @schema_name.attribute_definition
(
...
CREATE TABLE @schema_name.cohort
(
    cohort_definition_id  bigint   not null ,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE @schema_name.cohort_attribute
(
    cohort_definition_id    bigint not null,
    subject_id              bigint not null,
    cohort_start_date       DATE   not null,
