...
CREATE TABLE pg.@schema_name.person
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.observation_period
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.visit_occurrence
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.visit_detail
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.condition_occurrence
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.drug_exposure
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.procedure_occurrence
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.device_exposure
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.measurement
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.observation
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.death
(
    person_id               bigint      NOT NULL,
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.note
(
...
CREATE TABLE pg.@schema_name.note_nlp
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.specimen
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.fact_relationship
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.location
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.care_site
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.provider
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.payer_plan_period
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.cost
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.drug_era
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.dose_era
(
...
--HINT DISTRIBUTE ON KEY (person_id)
CREATE TABLE pg.@schema_name.condition_era
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.metadata
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.cdm_source
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.concept
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.vocabulary
(
    vocabulary_id         varchar(50)  NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.domain
(
    domain_id         varchar(20)  NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.concept_class
(
    concept_class_id         varchar(20)  NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.concept_relationship
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.relationship
(
    relationship_id         varchar(20)  NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.concept_synonym
(
    concept_id           bigint        NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.concept_ancestor
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.source_to_concept_map
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.drug_strength
(
    drug_concept_id             bigint     NOT NULL,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.cohort_definition
(
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.attribute_definition
(
...
DROP TABLE IF EXISTS pg.@schema_name.cohort;
CREATE TABLE pg.@schema_name.cohort
(
    cohort_definition_id  bigint   not null ,
...
--HINT DISTRIBUTE ON RANDOM
CREATE TABLE pg.@schema_name.cohort_attribute
(
    cohort_definition_id    bigint not null,
    subject_id              bigint not null,
    cohort_start_date       DATE   not null,
