...
--changeset alp:V1.0.0.1.1__alter_research_subject_table

--Add 2 new columns(EXTENSION_URL, EXTENSION_VALUESTRING) to GDM.RESEARCH_SUBJECT table 
ALTER TABLE "GDM.RESEARCH_SUBJECT" ADD (EXTENSION_URL NVARCHAR(500) NULL, EXTENSION_VALUESTRING VARCHAR(10) NULL);

--Add 2 new columns(EXTENSION_URL, EXTENSION_VALUESTRING) to the VIEW::GDM.RESEARCH_SUBJECT_BASE
