...
--changeset alp:V5.3.1.1.9__qe_omop_views

CREATE VIEW "VIEW::OMOP.PATIENT" (
  "PATIENT_ID",
  "BIRTH_DATE",
  "MONTH_OF_BIRTH",
  "YEAR_OF_BIRTH",
    ...
    (
      (
        (
          ...
          LEFT OUTER JOIN "CONCEPT" AS "gender_c_$2" ON (
            "gender_c_$2"."CONCEPT_ID" = "p_$0"."GENDER_CONCEPT_ID"
          )
        )
        LEFT OUTER JOIN "CONCEPT" AS "race_c_$3" ON (
          "race_c_$3"."CONCEPT_ID" = "p_$0"."RACE_CONCEPT_ID"
        )
      )
      LEFT OUTER JOIN "CONCEPT" AS "ethnicity_c_$4" ON (
  ...
  (
    (
      (
        ...
        INNER JOIN "CONCEPT" AS "t_$3" ON (
          "t_$3"."CONCEPT_ID" = "co_$0"."CONDITION_TYPE_CONCEPT_ID"
        )
      )
      LEFT OUTER JOIN "CONCEPT" AS "s_$4" ON (
        "s_$4"."CONCEPT_ID" = "co_$0"."CONDITION_SOURCE_CONCEPT_ID"
      )
    )
    LEFT OUTER JOIN "CONCEPT" AS "cs_$5" ON (
...
CREATE VIEW "VIEW::OMOP.COND_ERA" (
    "CONDITION_ERA_ID",
    "CONDITION_CONCEPT_ID",
    "CONDITION_NAME",
    "PATIENT_ID",
...
CREATE VIEW "VIEW::OMOP.COND_ICD10" (
    "CONDITION_OCCURRENCE_ID",
    "CONDITION_CONCEPT_ID",
    "CONDITION_NAME",
    "CONDITION_TYPE_NAME",
  ...
  (
    (
      (
        ...
        LEFT OUTER JOIN "CONCEPT" AS "t_$3" ON (
          "t_$3"."CONCEPT_ID" = "co_$0"."CONDITION_TYPE_CONCEPT_ID"
        )
      )
      LEFT OUTER JOIN "CONCEPT" AS "s_$4" ON (
...
FROM
  (
    ...
    LEFT OUTER JOIN "CONCEPT" AS "m_$3" ON (
  ...
  (
    (
      (
        ...
        LEFT OUTER JOIN "CONCEPT" AS "u_$3" ON ("u_$3"."CONCEPT_ID" = "s_$0"."UNIT_CONCEPT_ID")
      )
      LEFT OUTER JOIN "CONCEPT" AS "a_$4" ON (
        "a_$4"."CONCEPT_ID" = "s_$0"."ANATOMIC_SITE_CONCEPT_ID"
      )
    )
    LEFT OUTER JOIN "CONCEPT" AS "d_$5" ON (
...
FROM
  (
    ...
    LEFT OUTER JOIN "CONCEPT" AS "t_$1" ON (
...
FROM
  (
    (
      ...
      LEFT OUTER JOIN "CONCEPT" AS "vt_$4" ON (
        "vt_$4"."CONCEPT_ID" = "m_$0"."VALUE_AS_CONCEPT_ID"
      )
    )
    LEFT OUTER JOIN "CONCEPT" AS "u_$5" ON ("u_$5"."CONCEPT_ID" = "m_$0"."UNIT_CONCEPT_ID")
  ) 
WITH READ ONLY;


CREATE VIEW "VIEW::OMOP.DRUG_EXP" (
    "DRUG_EXPOSURE_ID",
    "PATIENT_ID",
    "DRUG_CONCEPT_ID",
    "DRUG_NAME",
...
CREATE VIEW "VIEW::OMOP.DRUG_ERA" (
    "DRUG_ERA_ID",
    "PATIENT_ID",
    "DRUG_NAME",
    "DRUG_ERA_START_DATE",
...
FROM
  (
    ...
    LEFT OUTER JOIN "CONCEPT" AS "c_$2" ON (
      "c_$2"."CONCEPT_ID" = "de_$0"."DRUG_CONCEPT_ID"
    )
  ) 
WITH READ ONLY;
...
CREATE VIEW "VIEW::OMOP.DOSE_ERA" (
    "DOSE_ERA_ID",
    "PATIENT_ID",
    "DRUG_NAME",
    "UNIT_NAME",
...
CREATE VIEW "VIEW::OMOP.DEVICE_EXPOSURE" (
    "DEVICE_EXPOSURE_ID",
    "PATIENT_ID",
    "DEVICE_NAME",
    "DEVICE_CONCEPT_ID",
